    ...
    <ol className="flex flex-col gap-6">
      <TutorialStep title="Create some tables and insert some data">
        <p>
          ...
          for your Supabase project to create a table and insert some example data. If you&apos;re stuck for creativity, you can copy and paste the
          following into the{' '}
          <a
      ...
      <TutorialStep title="Enable Row Level Security (RLS)">
        <p>
          Supabase enables Row Level Security (RLS) by default. To query data from your <code>notes</code> table, you need to add a policy. You can do
          this in the{' '}
          <a
            href="https://supabase.com/dashboard/project/_/editor"
            className="font-bold text-foreground/80 hover:underline"
      ...
      <TutorialStep title="Explore the Supabase UI Library">
        <p>
          Head over to the{' '}
          <a href="https://supabase.com/ui" className="font-bold text-foreground/80 hover:underline">
            Supabase UI library
          </a>{' '}
